<template>
  <div class="link-share" v-if="datas != null">
    <div class="share-detail" v-if="currentComponent === 'index'">
      <div class="share-head">
        <div v-if="datas != null && datas.images.length > 0" >
        ...
        <div class="share-title">
          ...
          <div class="flex-sb">
            ...
            <div class="flex-row"><x-button class="shopowner"  @click.native="passPage()">我是店长</x-button></div>
          </div>
      ...
      <div class="share-head-last">
        <div class="show-img" v-if="datas.detail != null && datas.detail.images.length >0">
          <img v-for="(item, index) in datas.detail.images" :key="index" :src="item.imgUrl"/>
        </div>
      </div>
      <div class="share-footer" >
        <tabbar slot="bottom" v-if="PassInfo">
    ...
    <div v-if="currentComponent !== 'index' && currentComponent ==='edit-pass'">
      <component :is="currentComponent" @back="handleBackPass" :passWord="PassInfo.passWord" :iphone="PassInfo.mobile" :qq="PassInfo.qq"></component>
    </div>
  </div>
</template>
